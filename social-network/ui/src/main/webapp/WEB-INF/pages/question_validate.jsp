    ...
    <body>
        <div class="validation-page">
            <div class="container">
                ...
                <f:form class="form" method="post" autocomplete="off" action="/ui/user_recovery/second_phase.do" modelAttribute="answer" novalidate="novalidate">
                    <label for="answer">Ответьте на секретный вопрос:</label>
                    <p class="question">${question}?</p>
                    <input id="answer" type="password" name="answer" value="" maxlength="255" placeholder="Ответ" required="required">
                    <input class="submit-btn" type="submit" value="Ответить"> 
                </f:form>  
            </div>
        </div>
